...
class RickAndMortyRemoteDataSource(private val client: HttpClient) : RickAndMortyRemoteSource {
    ...
    override suspend fun fetchCharacters() = client.get<CharactersApiModel>(charactersUrl)

    override suspend fun fetchLocations() = client.get<LocationsApiModel>(locationsUrl)

    override suspend fun fetchEpisodes() = client.get<EpisodesApiModel>(episodesUrl)
}
